...
const Watch = () => {
    ...
    const { setgkanimeWatched } = useLocalStorage()
    ...
    return (
        <section id='episode' className='episode'>
            <Helmet>
                <title>
                    gkanime - {`Watch ${animeResult?.anime?.title?.romaji || animeResult?.anime?.title?.english} Episode ${animeResult?.number} - ${animeResult?.title}`}
                    </title>
                <meta 
                    name='description' 
