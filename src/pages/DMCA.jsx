    ...
    return (
        <section className='dmca'>
            <div className='container container__dmca'>
                ...
                <p>
                    The anime streaming website (gkanime) provides links to content hosted by third-party sites. We do not host any of the anime or other content ourselves, and we do not have control over the content hosted on these third-party sites. We simply provide links to these sites as a service to our users.
                </p>
                <p>
                ...
                <p>
                    Please send your DMCA takedown notice to <a href="mailto: gauravkarthik22@gmail.com">gauravkarthik22@gmail.com</a>. We will promptly investigate and take appropriate action in accordance with the DMCA.
                </p>
            </div>
        </section>
    )
